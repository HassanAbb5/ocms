...
<?php 
  ...
  $sql_page= "SELECT * FROM complaints WHERE sender_id = $user_id AND responded='0' ";
...
<body>
 ...
 <?php 
  ...
  <div class="main-content" >
    ...
    <h2 class="p-2 mb-3 text-center wow fadeInDown">Pending Complaints</h2>


    
      <?php 
        $complaints_query="SELECT * FROM complaints WHERE sender_id = $user_id AND responded='0' ORDER BY complaint_id DESC  LIMIT ". $the_page_first_result . ',' . $results_per_page;
    ...
    <a class="page-link " href="pending.php?page=<?php echo $previous; ?> "><?php //if($page <= 1){echo "";}else{echo "previous";} ?>Previous</a>
    </li>

    <?php for ($page=1; $page <= $number_of_pages ; $page++) { ?>
        
        <li class="page-item <?php if($_GET['page']==$page){echo 'active';}else{echo '';} ?> ">
        <a class="page-link " href="pending.php?page=<?php echo $page; ?> "><?php echo $page; ?></a>
        </li>
    ...
    <a class="page-link" href="pending.php?page=<?php echo $next; ?> "> <?php //if ($page >= $number_of_pages){ echo ''; }else{echo "Next";} ?>Next</a>
    </li>
