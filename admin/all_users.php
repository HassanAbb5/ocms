 ...
 <?php 
  ...
  <div class="main-content" >
    ...
    <div class="bg-white rounded py-4">
      ...
      <h2 class="mb-4 p-2 text-center wow fadeInDown">All Users</h2>
      </div>


    
      <?php 
        $user_query="SELECT * FROM users  ORDER BY id  LIMIT ". $the_page_first_result . ',' . $results_per_page;
  ...
  <?php */ if ( mysqli_num_rows($user_results) > 0): ?>
    ...
    <a class="page-link " href="all_users.php?page=<?php echo $previous; ?> "><?php //if($page <= 1){echo "";}else{echo "previous";} ?>Previous</a>
    </li>

    <?php for ($page=1; $page <= $number_of_pages ; $page++) { ?>
        
        <li class="page-item <?php if($_GET['page']==$page){echo 'active';}else{echo '';} ?> ">
        <a class="page-link " href="all_users.php?page=<?php echo $page; ?> "><?php echo $page; ?></a>
        </li>
    ...
    <a class="page-link" href="all_users.php?page=<?php echo $next; ?> "> <?php //if ($page >= $number_of_pages){ echo ''; }else{echo "Next";} ?>Next</a>
    </li>
