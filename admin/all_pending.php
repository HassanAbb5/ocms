...
<?php 
  ...
  $sql_page= "SELECT * FROM complaints WHERE responded='0' ";
...
<body>
 ...
 <?php 
  ...
  <div class="main-content">
    ...
    <h2 class="my-4 p-2 text-center wow fadeInDown">Pending Complaints</h2>

    <?php 
          
      $sql_complaints = "SELECT * FROM complaints WHERE responded='0' ORDER BY complaint_id DESC  LIMIT  ". $the_page_first_result . ',' . $results_per_page;
    ...
    <a class="page-link " href="all_pending.php?page=<?php echo $previous; ?> "><?php //if($page <= 1){echo "";}else{echo "previous";} ?>Previous</a>
    </li>

    <?php for ($page=1; $page <= $number_of_pages ; $page++) { ?>
        
        <li class="page-item <?php if($_GET['page']==$page){echo 'active';}else{echo '';} ?> ">
        <a class="page-link " href="all_pending.php?page=<?php echo $page; ?> "><?php echo $page; ?></a>
        </li>
    ...
    <a class="page-link" href="all_pending.php?page=<?php echo $next; ?> "> <?php //if ($page >= $number_of_pages){ echo ''; }else{echo "Next";} ?>Next</a>
    </li>
    ...
    <?php else: ?>
      <h5 class="text-center">There are no pending Complaints!</h5>
    <?php endif ?>  
