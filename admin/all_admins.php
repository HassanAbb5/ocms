 ...
 <?php 
  ...
  <div class="main-content" >
    ...
    <div class="bg-white rounded py-4">
      ...
      <h2 class="mb-4 p-2 text-center wow fadeInDown">All Administrators</h2>
      </div>


    
      <?php 
        $admin_query="SELECT * FROM admin  ORDER BY admin_id  LIMIT ". $the_page_first_result . ',' . $results_per_page;
         $admin_results=mysqli_query($db_conn, $admin_query);
     /* ?>
  <?php */ if ( mysqli_num_rows($admin_results) > 0): ?>
      ...
      <table class="table table-hover wow fadeInRight ">
        ...
        <tbody>
          ...
          <?php  while ($admin = mysqli_fetch_assoc($admin_results)){ ?>
          <tr>
            <th scope="row">
            ...
            <td><a href="view_admin.php?admin_id=<?php echo $admin['admin_id']; ?>" class="btn btn-primary">View</a></td>
          </tr>
    ...
    <a class="page-link " href="all_admins.php?page=<?php echo $previous; ?> "><?php //if($page <= 1){echo "";}else{echo "previous";} ?>Previous</a>
    </li>

    <?php for ($page=1; $page <= $number_of_pages ; $page++) { ?>
        
        <li class="page-item <?php if($_GET['page']==$page){echo 'active';}else{echo '';} ?> ">
        <a class="page-link " href="all_admins.php?page=<?php echo $page; ?> "><?php echo $page; ?></a>
        </li>
    ...
    <a class="page-link" href="all_admins.php?page=<?php echo $next; ?> "> <?php //if ($page >= $number_of_pages){ echo ''; }else{echo "Next";} ?>Next</a>
    </li>
      ...
      <?php else: ?>
          <h5 class="text-center">No Administrators were found!</h5>
    <?php endif ?>
